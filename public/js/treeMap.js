class TreeMap {
    constructor(worldMap){
        ...
        this.causesOfDeathDetails= {
            ...
            "Respiratory disease":"Respiratory disease is a medical term that encompasses pathological conditions affecting the organs and tissues that make gas exchange possible in higher organisms, and includes conditions of the upper \nrespiratory tract, trachea, bronchi, bronchioles, alveoli, pleura and pleural cavity, and the nerves and muscles of breathing. Respiratory diseases range from mild and self-limiting, such as \nthe common cold, to life-threatening entities like bacterial pneumonia, pulmonary embolism, acute asthma and lung cancer.",
            "Liver disease": "liver disease in the clinical context is a disease process of the liver that involves a process of progressive destruction and regeneration of the liver parenchyma leading to fibrosis and cirrhosis. \"Chronic \nliver disease\" refers to disease of the liver which lasts over a period of six months. It consists of a wide range of liver pathologies which include inflammation (chronic hepatitis), liver \ncirrhosis, and hepatocellular carcinoma. The entire spectrum need not be experienced.",
            "Diabetes": "Diabetes mellitus (DM), commonly referred to as diabetes, is a group of metabolic disorders in which there are high blood sugar levels over a prolonged period. Symptoms of high blood sugar include frequent urination, \nincreased thirst, and increased hunger. If left untreated, diabetes can cause many complications. Acute complications can include diabetic ketoacidosis, hyperosmolar hyperglycemic state, \nor death. Serious long-term complications include cardiovascular disease, stroke, chronic kidney disease, foot ulcers, and damage to the eyes.",
            "Digestive disease": "Gastrointestinal diseases refer to diseases involving the gastrointestinal tract, namely the esophagus, stomach, small intestine, large intestine and rectum, and the accessory organs of digestion, the liver, \ngallbladder, and pancreas.",
            "Hepatitis": "Hepatitis is inflammation of the liver tissue. Some people have no symptoms whereas others develop yellow discoloration of the skin and whites of the eyes, poor appetite, vomiting, tiredness, abdominal pain, or diarrhea. \nHepatitis may be temporary (acute) or long term (chronic) depending on whether it lasts for less than or more than six months. Acute hepatitis can sometimes resolve on its own, progress\n to chronic hepatitis, or rarely result in acute liver failure. Over time the chronic form may progress to scarring of the liver, liver failure, or liver cancer.",
            "Cancers": "Cancer is a group of diseases involving abnormal cell growth with the potential to invade or spread to other parts of the body. These contrast with benign tumors, which do not spread to other parts of the body. Possible \nsigns and symptoms include a lump, abnormal bleeding, prolonged cough, unexplained weight loss and a change in bowel movements. While these symptoms may indicate cancer, they may have other\n causes. Over 100 types of cancers affect humans.",
            "Parkinson's": "Parkinson's disease (PD) is a long-term degenerative disorder of the central nervous system that mainly affects the motor system. The symptoms generally come on slowly over time. Early in the disease, the most obvious \nare shaking, rigidity, slowness of movement, and difficulty with walking. Thinking and behavioral problems may also occur. Dementia becomes common in the advanced stages of the disease.\n Depression and anxiety are also common, occurring in more than a third of people with PD. Other symptoms include sensory, sleep, and emotional problems. The main motor symptoms are collectively \ncalled \"parkinsonism\", or a \"parkinsonian syndrome\".",
            "Fire": "Accidents caused by fire can result in serious injury and damage to personal property. Fire hazards are not always obvious in and around the home, so accidents involving fire are often unexpected and sudden. These accidents \ncan occur from faulty wiring, defective products, discarded cigarettes left on flammable materials, and smoke detectors that fail to activate. Car fires can trap victims inside a vehicle.\n A major concern for anyone involved in a fire accident is the damage smoke inhalation can cause to the lungs.",
            "Malaria":"Malaria is a mosquito-borne infectious disease affecting humans and other animals caused by parasitic single-celled microorganisms belonging to the Plasmodium group. Malaria causes symptoms that typically include fever, \ntiredness, vomiting, and headaches. In severe cases it can cause yellow skin, seizures, coma, or death. Symptoms usually begin ten to fifteen days after being bitten by an infected mosquito.\n If not properly treated, people may have recurrences of the disease months later. In those who have recently survived an infection, reinfection usually causes milder symptoms. This partial \nresistance disappears over months to years if the person has no continuing exposure to malaria.",
            "Drowning":"Drowning is defined as respiratory impairment as a result of being in or under a liquid. Drowning typically occurs silently, with only a few people able to wave their hands or call for help. Symptoms following rescue may \ninclude breathing problems, vomiting, confusion, or unconsciousness. Occasionally symptoms may not appear until up to six hours afterwards. Drowning may be complicated by low body temperature,\n aspiration of vomit, or acute respiratory distress syndrome.",
            "Homicide":"Homicide is the act of one human killing another. A homicide requires only a volitional act by another person that results in death, and thus a homicide may result from accidental, reckless, or negligent acts even if \nthere is no intent to cause harm. Homicides can be divided into many overlapping legal categories, including murder, manslaughter, justifiable homicide, killing in war (either following the \nlaws of war or as a war crime), euthanasia, and capital punishment, depending on the circumstances of the death. These different types of homicides are often treated very differently in human \nsocieties; some are considered crimes, while others are permitted or even ordered by the legal system.",
            "HIV/AIDS":"Human immunodeficiency virus infection and acquired immune deficiency syndrome (HIV/AIDS) is a spectrum of conditions caused by infection with the human immunodeficiency virus (HIV). Following initial infection, a \nperson may not notice any symptoms or may experience a brief period of influenza-like illness. Typically, this is followed by a prolonged period with no symptoms. As the infection progresses, it \ninterferes more with the immune system, increasing the risk of developing common infections such as tuberculosis, as well as other opportunistic infections, and tumors that rarely affect people \nwho have working immune systems. These late symptoms of infection are referred to as acquired immunodeficiency syndrome (AIDS). This stage is often also associated with unintended weight loss.",
            "Drug disorder":"Substance abuse, also known as drug abuse, is a patterned use of a drug in which the user consumes the substance in amounts or with methods which are harmful to themselves or others, and is a form of substance-related \ndisorder. Widely differing definitions of drug abuse are used in public health, medical and criminal justice contexts. In some cases criminal or anti-social behavior occurs when the \nperson is under the influence of a drug, and long term personality changes in individuals may occur as well. In addition to possible physical, social, and psychological harm, use of some drugs may \nalso lead to criminal penalties, although these vary widely depending on the local jurisdiction.",
            "Tuberculosis":"Tuberculosis (TB) is an infectious disease usually caused by the bacterium Mycobacterium tuberculosis (MTB). Tuberculosis generally affects the lungs, but can also affect other parts of the body. Most infections do \nnot have symptoms, in which case it is known as latent tuberculosis. About 10% of latent infections progress to active disease which, if left untreated, kills about half of those infected. \nThe classic symptoms of active TB are a chronic cough with blood-containing sputum, fever, night sweats, and weight loss. It was historically called \"consumption\" due to the weight loss. \nInfection of other organs can cause a wide range of symptoms.",
            "Road incidents":"A traffic collision, also called a motor vehicle collision (MVC) among other terms, occurs when a vehicle collides with another vehicle, pedestrian, animal, road debris, or other stationary obstruction, such as a \ntree, pole or building. Traffic collisions often result in injury, death, and property damage. A number of factors contribute to the risk of collision, including vehicle design, speed of \noperation, road design, road environment, and driver skill, impairment due to alcohol or drugs, and behavior, notably speeding and street racing. Worldwide, motor vehicle collisions lead to death \nand disability as well as financial costs to both society and the individuals involved.",
            ...
            "Alcohol disorder":"Alcoholism, also known as alcohol use disorder (AUD), is a broad term for any drinking of alcohol that results in mental or physical health problems. The disorder was previously divided into two types: alcohol \nabuse and alcohol dependence. In a medical context, alcoholism is said to exist when two or more of the following conditions are present: a person drinks large amounts over a long time \nperiod, has difficulty cutting down, acquiring and drinking alcohol takes up a great deal of time, alcohol is strongly desired, usage results in not fulfilling responsibilities, usage results in social \nproblems, usage results in health problems, usage results in risky situations, withdrawal occurs when stopping, and alcohol tolerance has occurred with use. Risky situations include drinking \nand driving or having unsafe sex, among other things. Alcohol use can affect all parts of the body, but it particularly affects the brain, heart, liver, pancreas and immune system. This can result \nin mental illness, Wernicke–Korsakoff syndrome, irregular heartbeat, liver cirrhosis and increased cancer risk, among other diseases.",
            ...
            "Intestinal infectious":"Intestinal infectious diseases include a large number of infections of the bowels including: cholera, typhoid fever, paratyphoid fever, other types of salmonella infections, shigellosis, botulism, gastroenteritis, \nand amoebiasis among others. Typhoid and paratyphoid resulted in 221,000 deaths in 2013 down from 259,000 deaths in 1990. Other diseases which result in diarrhea caused another 1.3 \nmillion additional deaths in 2013 down from 2.6 million deaths in 1990.",
            "Protein-energy malnutrition":"Protein–energy malnutrition (PEM) is a form of malnutrition that is defined as a range of pathological conditions arising from coincident lack of dietary protein and/or energy (calories) in varying \nproportions. EM is fairly common worldwide in both children and adults and accounts for 6 million deaths annually. In the industrialized world, PEM is predominantly seen in hospitals, is \nassociated with disease, or is often found in the elderly. Note that PEM may be secondary to other conditions such as chronic renal disease or cancer cachexia in \nwhich protein energy wasting may occur.Protein–energy malnutrition affects children the most because they have \nless protein intake. The few rare cases found in the developed world are almost entirely found in small children as \na result of fad diets, or ignorance of the nutritional needs of children, particularly in cases of milk allergy.",
            "Conflict":"In wartime, you'll hear the word casualty used often for someone killed or injured. But casualty can also refer to deaths or injuries suffered in an accident or some other unfortunate event. The term \"casualties of war\" \nhas been around for a while and refers to the ugly downside of military victory. Anyone who loses life or limb, either in the fighting or as a civilian, is called a casualty. If you're \nfeeling poetic, though, you can extend the meaning to include, say, the children of a divorce: while they don't die and aren't physically injured, their emotional \nsuffering qualifies them to be called casualties of their parents' fighting. Driving drunk, too, results in \ncasualties.",
